...
sg = StackedGeneralizer(clfs, ensemble = XGBlend, n_folds=4, stratify=True, original = True, epoch=2000, batch_size=2000)
sg.fit(X_train, y_train, X_test)
pd.DataFrame(sg.predict()).to_csv('SGpredictions.csv')